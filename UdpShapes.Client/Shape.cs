...
public class Shape {
    ...
    private static void DrawCustomEllipse(DrawingContext d, Brush brush, Point pos) =>
        d.DrawEllipse(brush, null, new Point(pos.X + 25, pos.Y + 25), 50, 25);
    private static void DrawCustomRectangle(DrawingContext d, Brush brush, Point pos) =>
        d.DrawRectangle(brush, null, new Rect(pos.X, pos.Y, 100, 50));
}
