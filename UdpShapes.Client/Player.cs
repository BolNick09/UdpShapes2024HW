...
public record Player 
{
    ...
    public void Draw(DrawingContext d)
    {
        ...
        FormattedText formattedText = new(Name, System.Globalization.CultureInfo.InvariantCulture, FlowDirection.LeftToRight, typeface, 30, textBrush);
        Point textPoint = Pos;
        textPoint.Y = Pos.Y - 50;
